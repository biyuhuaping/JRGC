...
- (instancetype)initWithNotiMessage:(NSString *)message
{
    if (self = [super init]) {
        ...
        lab1.textColor = UIColorWithRGB(0x333333);
        ...
        desLab1.textColor = UIColorWithRGB(0x999999);
        ...
        [button2 setBackgroundColor:UIColorWithRGB(0xfd4d4c)];
