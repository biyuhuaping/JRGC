...
- (void)gestureLockView:(KKGestureLockView *)gestureLockView didMovedWithPasscode:(NSString *)passcode;
@end
...
@property (nonatomic, strong) UIImage *wrongGestureNodeImage;

@property (nonatomic, strong) UIColor *lineColor;
@property (nonatomic, assign) CGFloat lineWidth;

@property (nonatomic, assign) BOOL bNeedWrong;
