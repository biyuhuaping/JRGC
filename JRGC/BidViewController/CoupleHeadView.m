...
- (void)createViews
{
    ...
    _keYongTipLabel = [[UILabel alloc] initWithFrame:CGRectMake(15.0f, 10.5, [Common getStrWitdth:@"可用金额" Font:14.0f].width, 16)];
    ...
    _inputMoneyTextFieldLable.textColor = UIColorWithRGB(0x333333);
