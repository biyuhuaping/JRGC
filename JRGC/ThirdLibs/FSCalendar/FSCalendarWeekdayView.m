...
- (void)configureAppearance
{
    ...
    for (NSInteger i = 0; i < self.weekdayPointers.count; i++) {
        ...
        label.text = useDefaultWeekdayCase ? [NSString stringWithFormat:@"%@", [weekdaySymbols[index] stringByReplacingOccurrencesOfString:@"周" withString:@""]] : [weekdaySymbols[index] uppercaseString];
    }
