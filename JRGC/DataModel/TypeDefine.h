...
#define VALIDPOMOCODE       @"newuserregist/isexitpomocode"
...
#define CMT_IDNO_INFO       @"newsafe/identityApprove"
...
#define CHECKMYMONEY                  @"newaccount/getAvailable"
...
#define GETTIKIT                      @"newuserregist/getTickit"
...
#define LEVELISOPEN                   @"newaccount/userLevelIsOpen" //等级工分开关
