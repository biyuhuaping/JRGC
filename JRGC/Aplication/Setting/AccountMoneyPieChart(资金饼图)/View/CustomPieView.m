...
- (void)drawRightText
{
    ...
    CGFloat textUseHeight = [self heightForTextString:self.pieTitle width:1000 fontSize:13];
    CGFloat textOffset = (self.realTextHeight - textUseHeight)/2;
    
    if (self.pieTitle) {
        
    [self.pieTitle drawInRect:CGRectMake(textX - colorHeight, textY - self.realTextSpace-textOffset - textUseHeight , viewWidth-textX - colorHeight, self.realTextHeight) withAttributes:@{NSForegroundColorAttributeName :UIColorWithRGB(0x555555), NSFontAttributeName:[UIFont systemFontOfSize:13]}];
    }
...
//        
//    }
    NSMutableArray *colorArray = [[NSMutableArray alloc]initWithArray:@[UIColorWithRGB(0xff6766),UIColorWithRGB(0x8eb1ff),UIColorWithRGB(0xffe34a),UIColorWithRGB(0x7ddbb9),UIColorWithRGB(0xab70d8),UIColorWithRGB(0xffa13c)]];
