...
//  Copyright © 2016年 秦洋月. All rights reserved.
//
...
static CGFloat arrow_H = 5;//箭头高
static CGFloat arrow_W = 13;//箭头宽
...
- (void)showViewFromPoint:(CGPoint)viewPoint
    ...
    [self reloadData];
    [NSTimer scheduledTimerWithTimeInterval:55.0f target:self selector:@selector(dismiss) userInfo:nil repeats:NO];
    //计算高度
    ...
    [KEYWINDOW addSubview:self.backImageView];
...
//    _arrow_offset = targetView?_arrow_offset:0;
    ...
    _backImageView.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y - self.hightIMAGThanTABLE, self.frame.size.width, self.frame.size.height + self.hightIMAGThanTABLE);
...
- (void)setEndShowType:(MLMOptionSelectViewEndShow)endShowType {
    ...
    switch (endShowType) {
        case MLMOptionSelectViewEndShowTopRight:
        {
            ...
            self.backImageView.layer.anchorPoint = CGPointMake(_arrow_offset, 1);
        }
            break;
        ...
        case MLMOptionSelectViewEndShowBottomRight:
        {
            ...
            self.backImageView.layer.anchorPoint = CGPointMake(_arrow_offset, 0);
        ...
        case MLMOptionSelectViewEndShowRightTop:
        {
            ...
            self.backImageView.layer.anchorPoint =  CGPointMake(0, _arrow_offset);
        ...
        case MLMOptionSelectViewEndShowLeftTop:
        {
            ...
            self.backImageView.layer.anchorPoint = CGPointMake(1, _arrow_offset);
    ...
    _backImageView.size = CGSizeMake(viewWidth, viewHeight);
...
- (void)zoomOrOn {
        ...
        if (_diretionType==MLMOptionSelectViewBottom || _diretionType==MLMOptionSelectViewTop) {
            ...
            self.backImageView.transform = CGAffineTransformMakeScale(1, 0.001);

        } else {
            self.transform = CGAffineTransformMakeScale(0.001, 1);
            self.backImageView.transform = CGAffineTransformMakeScale(0.001, 1);
        }
    } else {
        self.transform = CGAffineTransformMakeScale(0.001, 0.001);
        self.backImageView.transform = CGAffineTransformMakeScale(0.001, 0.001);
    }
}
...
- (UIView *)cover {
    if (!_cover) {
        ...
        _backImageView=[[UIImageView alloc]initWithFrame:CGRectMake(self.frame.origin.x, self.frame.origin.y - self.hightIMAGThanTABLE, self.frame.size.width, self.frame.size.height + self.hightIMAGThanTABLE)];
//        [_backImageView setImage:[UIImage imageNamed:@"message_option_bg"]];
       [_backImageView setImage:[UIImage imageNamed:self.tablviewBGname]];
