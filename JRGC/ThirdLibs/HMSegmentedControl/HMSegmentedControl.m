...
- (void)drawRect:(CGRect)rect {
    ...
    _lineView = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height - 2, ScreenWidth, 2)];
    _lineView.backgroundColor = UIColorWithRGB(0xebebeb);
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, _lineView.frame.size.height - 0.5, ScreenWidth, 0.5)];
