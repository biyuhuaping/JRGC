...
- (void)initViewControls
{
    ...
    UIImageView *logoImageVW = [[UIImageView alloc] initWithFrame:CGRectMake((self.frame.size.width - 70)/2, (bkView.frame.size.height -70)/3, 70, 93)];    logoImageVW.image = [UIImage imageNamed:@"404bg.png"];
