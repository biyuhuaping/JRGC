...
#define animationWidth  (self.frame.size.height -50)
...
-(void)addBottomAnimationView{
    ...
    currentAnimationView = [[UIImageView alloc]initWithFrame:CGRectMake((CWSCREEN_WIDTH-animationWidth)/2, self.frame.size.height-animationWidth-40, animationWidth, animationWidth)];
...
-(void)showAnimation:(UIImage *)imageA imageB:(UIImage *)imageB{
    ...
    //动画提示
    nextAnimationView = [[UIImageView alloc]initWithFrame:CGRectMake(CWSCREEN_WIDTH+10, self.frame.size.height-animationWidth-50, animationWidth, animationWidth)];
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        currentAnimationView.frame = CGRectMake(-animationWidth, self.frame.size.height-animationWidth-50, animationWidth, animationWidth);
