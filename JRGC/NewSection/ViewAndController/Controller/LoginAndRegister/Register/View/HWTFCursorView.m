...
- (void)configTextField
{
    ...
    for (NSInteger i = 0; i < self.itemCount; i++)
    {
        ...
        line.backgroundColor = [Color color:PGColorOptionCellSeparatorGray];
...
- (void)setupView
{
    ...
    cursorView.backgroundColor = [Color color:PGColorOptionCursorPurple];
    cursorView.alpha = 0;
