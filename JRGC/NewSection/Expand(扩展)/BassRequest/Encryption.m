...
+ (NSDictionary *)getSinaturDictWithOrginalDict:(NSDictionary *)dict
{
    
    NSString *valueStr = [self newGetParStr:dict];
    NSString *signature = [self getSinatureWithPar:valueStr];
    NSMutableDictionary *signatureDict = [NSMutableDictionary dictionaryWithDictionary:dict];
    [signatureDict setValue:signature forKey:@"signature"];
