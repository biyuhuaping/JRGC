...
@implementation UCFInvestMicroMoneyCell
...
- (IBAction)cyclePressClicked:(UIButton *)sender {
    if ([self.delegate respondsToSelector:@selector(homelistCell:didClickedProgressViewAtIndexPath:)]) {
        [self.delegate homelistCell:self didClickedProgressViewAtIndexPath:self.indexPath];
    }
}
