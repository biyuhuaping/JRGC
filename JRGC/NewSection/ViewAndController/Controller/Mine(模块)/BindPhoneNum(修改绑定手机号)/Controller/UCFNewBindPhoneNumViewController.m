...
// 标题
@property (weak, nonatomic) NZLabel *titleLabel;
// 已绑定的手机号
@property (weak, nonatomic) NZLabel *bindedPhoneLabel;
// 新手机号
@property (weak, nonatomic) UITextField *moddifyPhoneTextField;
// 登录密码
@property (weak, nonatomic) UITextField *loginPwdTextField;
// 下一步
@property (weak, nonatomic) UIButton *nextStep;
