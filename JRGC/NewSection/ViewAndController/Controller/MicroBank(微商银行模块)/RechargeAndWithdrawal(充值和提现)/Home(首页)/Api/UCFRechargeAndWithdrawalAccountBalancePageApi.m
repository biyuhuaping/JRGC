//
//  UCFRechargeAndWithdrawalAccountBalancePageApi.m
//  JRGC
//
...
@implementation UCFRechargeAndWithdrawalAccountBalancePageApi
{
    //    NSString* _pageIndex;
    //    NSString* _pageSize;
 ...
 */
- (NSString *)requestUrl {
    return AccountBalancePageApiURL;
}
/**
...
- (NSString *)modelClass
{
    return @"UCFRechargeAndWithdrawalAccountBalancePageModel";
}
@end
